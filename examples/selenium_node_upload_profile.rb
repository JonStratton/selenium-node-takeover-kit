...
newSession = {:desiredCapabilities => {:browserName => "firefox", :firefox_profile => encoded_profile}, :capabilities => {:firstMatch => [{:browserName => "firefox", :"moz:firefoxOptions" => encoded_profile}]}}
